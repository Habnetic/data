...
AMAX_DIR = Path("processed/HAM/hazards/pluvial")
OUT_PATH = Path("processed/HAM/hazards/pluvial/H_pluvial_v1_grid.nc")
...
def main() -> None:
    files = [AMAX_DIR / f"era5_land_tp_amax_{y}_HAM.nc" for y in YEARS]
