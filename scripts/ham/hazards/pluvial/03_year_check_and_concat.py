...
RAW = Path("raw/HAM/hazards/pluvial/ERA5_Land")
OUT = Path("processed/HAM/hazards/pluvial")
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description=(
            "HAM Phase 3: Validate ERA5-Land hourly tp monthly files for a given year, "
...
def main() -> None:
    ...
    files = sorted(raw_dir.glob(f"era5_land_tp_hourly_{year}-*_HAM.nc"))
    ...
    try:
        ...
        # ERA5-Land tp is typically in meters; hazard spec locks mm.
        tp_mm = ds["tp"] * 1000.0
        try:
        ...
        out_path = out_dir / f"era5_land_tp_amax_{year}_HAM.nc"
