...
OUT = REPO_ROOT / "raw" / "DON" / "hazards" / "pluvial" / "ERA5_Land"
...
# Chosen to safely cover Donostia / San Sebastián and immediate surroundings.
AREA = [43.55, -2.15, 43.20, -1.85]
...
def main() -> None:
    ...
    for y in YEARS:
        for m in MONTHS:
            target = OUT / f"era5_land_tp_hourly_{y}-{m}_DON.nc"
