...
AMAX_DIR = Path("processed/RTM/hazards/pluvial")
OUT_PATH = Path("processed/RTM/hazards/pluvial/H_pluvial_v1_grid.nc")

YEARS = list(range(1991, 2021))


def main() -> None:
    files = [AMAX_DIR / f"era5_land_tp_amax_{y}_RTM.nc" for y in YEARS]
